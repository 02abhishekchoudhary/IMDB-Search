...
// Storing fav movies in arrays
var favouiteMoviesList = [];

// Deleting fav movies from local storage
...
// opening info.html page also set data to local storage
...
// Getting data from local storage and add into html
